...
$sql = "SELECT users.full_name, chat_messages.message, chat_messages.timestamp
        ...
        WHERE chat_messages.sport = 'football'
...
<h1 class="heading">⚡BUZZ</h1>
    ...
    <title>Football Chat Room</title>
    ...
    <style>
       ...
       .heading {
        ...
        body {
	        height: 100vh;
	        width: 100vw;
            background: url(https://wallpapercave.com/wp/76enKL8.jpg)
        }
        #chatMessages {
...
<body>
    <div class="container mt-5">
        <h1 class="roomtitle text-center">Football Chat Room</h1>
...
<script>
    function refreshChatMessages() {
        ...
        xhr.open("GET", "get_chat_messages.php?sport=football", true);
        xhr.send();
    }
    ...
    function sendMessage() {
        ...
        xhr.send("sport=football&message=" + encodeURIComponent(messageInput));
    }
